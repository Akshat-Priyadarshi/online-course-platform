...
# We removed "id = AutoField" and set primary_key=True on the first ForeignKey.
# This prevents the crash because Django won't look for an 'id' column anymore.

class CourseContent(models.Model):
    course = models.ForeignKey(Course, models.DO_NOTHING, db_column='course_id', primary_key=True)
    content = models.ForeignKey(OnlineContent, models.DO_NOTHING, db_column='content_id')
...
class Enrollment(models.Model):
    student = models.ForeignKey(Student, models.DO_NOTHING, db_column='student_id', primary_key=True)
    course = models.ForeignKey(Course, models.DO_NOTHING, db_column='course_id')
    enrollment_date = models.DateField(blank=True, null=True)
    status = models.CharField(max_length=20, blank=True, null=True)
